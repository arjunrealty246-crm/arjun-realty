...
export const projects: Project[] = [
  ...
  },
  {
    ...
    seoTitle: "JB Hillside County | HMDA & RERA Plots on Sagar Highway",
    seoDescription: "30-acre HMDA & RERA approved gated villa community on Sagar Highway, Hyderabad, near BDL & BEL. 80 plots from 228–800 Sq Yd at ₹20,000/Sq.Yd. Enquire.",
    locationOverview: [
  ...
  },
  {
    ...
    targetKeywords: [
      "JB Serene County",
      "JB Serene County Kongarakalan",
      "HMDA approved plots Kongarakalan",
      "plots near Patancheru",
      "Tata Greenfield corridor plots",
      "Foxconn plots Telangana",
      "Adibatla TCS corridor plots",
      "ORR Exit 13 plots",
      "TSRERA registered plots",
      "bank loan plots Patancheru",
    ],
    ...
    faqs: [
      ...
      { q: "How close is JB Serene County to the Foxconn plant?", a: "JB Serene County sits near Kongarakalan along the Tata Greenfield Growth Corridor, about 1 KM from Patancheru — the same industrial belt as the Foxconn manufacturing plant and the Kaynes Technology unit, with ORR Exit No. 13 close by and the airport about 15 minutes away." },
      { q: "Is JB Serene County RERA registered as well as HMDA approved?", a: "Yes. JB Serene County is an HMDA Approved layout that is also TSRERA registered, with clear and secure title and a bank loan facility available for buyers." },
      { q: "Does JB Serene County have water supply and underground drainage?", a: "Yes. The layout includes a water supply network, an underground drainage system, underground electricity and LED street lighting, along with wide black top roads, landscaped parks, avenue plantation, a children's play area, a walking & jogging track, 24×7 security and CCTV surveillance." },
    ],
  ...
  },
  {
    ...
    targetKeywords: [
      ...
      "plots for sale in Vikarabad",
      "DTCP approved plots Vikarabad",
      "RERA approved plots Vikarabad",
      "villa plots in Vikarabad",
      "West Hyderabad plots",
      "150 acre gated layout Vikarabad",
      "plots near Shankarpally",
      "bank loan plots Vikarabad",
    ],
    ...
    faqs: [
      ...
      { q: "How far is JB Pristine City from Shankarpally and Chevella?", a: "The approach from West Hyderabad runs through Mokila, Shankarpally, Moinabad and Chevella via the four-lane expressway from ORR Exit No. 18. Shankarpally is an earlier stop on this same western corridor, while Chevella, Moinabad and Manneguda lead into Vikarabad, where JB Pristine City is actually located." },
      { q: "Is JB Pristine City DTCP approved and RERA registered?", a: "Yes. JB Pristine City is a 150-acre DTCP & RERA approved gated layout with clear titles. Phase 3 is separately registered with the Telangana Real Estate Regulatory Authority under RERA No. P02100010790 for Kothagadi, Vikarabad, valid from 07/02/2026 to 07/02/2028." },
      { q: "Which plot sizes are available for a villa in JB Pristine City?", a: "Plots are available in 150, 165, 183, 200, 220, 300, 400, 500 and 600 Sq. Yards, ranging from compact villa plots to large custom-home sites. Rates are quoted per Sq. Yard and currently start from ₹13,999/Sq. Yd." },
    ],
  ...
  },
  {
    ...
    targetKeywords: [
      "JB Serene City",
      "JB Serene City Ibrahimpatnam",
      "HMDA approved plots Ibrahimpatnam",
      "plots in Ibrahimpatnam",
      "Sagar Highway plots",
      "ORR Exit 12 plots",
      "gated township Ibrahimpatnam",
      "residential plots near Outer Ring Road",
      "bank loan plots Ibrahimpatnam",
      "660 acre township Hyderabad",
    ],
    ...
    faqs: [
      ...
      { q: "How connected is JB Serene City?", a: "JB Serene City is a highway-facing township in Ibrahimpatnam, South Hyderabad, with excellent connectivity to the ORR, the airport and Hyderabad's IT corridor." },
      { q: "What is the current status of the project?", a: "JB Serene City is live — HMDA approved and RERA registered — with over 100 families already residing and bookings open across the 660-acre integrated township." },
      { q: "How can I schedule a site visit to JB Serene City?", a: "You can contact the Arjun Realty team to schedule a site visit to JB Serene City in Ibrahimpatnam and get the latest plot availability and pricing." },
      { q: "What is the HMDA layout approval number for JB Serene City?", a: "JB Serene City is an HMDA Approved 660-acre layout in Ibrahimpatnam and is RERA Registered. The HMDA layout approval number and approved layout plan are shared along with the RERA documents on request — contact the Arjun Realty team before booking so you can verify the approval paperwork yourself." },
      { q: "How far is JB Serene City from ORR Exit 12?", a: "JB Serene City is a highway-facing township in Ibrahimpatnam with direct connectivity to the Outer Ring Road, so ORR Exit 12 and the southern ORR stretch are convenient for daily travel. Driving distance varies by entrance point and route, and the team shares an exact route map on enquiry." },
      { q: "Am I eligible for a bank loan on plots in JB Serene City?", a: "Bank loan facility is available on plots in JB Serene City through leading financial institutions. Because the township is HMDA approved and RERA registered, it qualifies for plot finance; final sanction still depends on your income, credit profile and the documentation of the specific plot." },
    ],
  ...
  },
  {
    ...
    seoTitle: "JB Nature Valley | DTCP & RERA Plots, Choutuppal, ₹8.5K/Sq.Yd",
    seoDescription: "720+ acre DTCP & RERA approved township at Choutuppal on NH-65, Hyderabad–Vijayawada. Plots 167–800 Sq Yd from ₹8,500/Sq.Yd. Book a site visit.",
    ...
    faqs: [
      ...
      { q: "How is JB Nature Valley connected to Hyderabad?", a: "JB Nature Valley sits on the NH-65 Hyderabad–Vijayawada Highway at Choutuppal, on the six-lane NH-65 expansion corridor and close to the proposed Regional Ring Road (RRR), giving residents and investors excellent connectivity to Hyderabad." },
      { q: "What is the current status of the project?", a: "JB Nature Valley is a live project — DTCP approved and RERA registered — and bookings are open across the 720+ acre satellite township." },
      { q: "How can I schedule a site visit to JB Nature Valley?", a: "You can contact the Arjun Realty team to schedule a site visit to JB Nature Valley at Choutuppal and get the latest plot availability and pricing." },
    ],
  ...
  },
  {
    ...
    relatedInsightSlugs: ["hyderabad-real-estate-market-update-q3-2026", "dtcp-hmda-fcda-approvals-which-to-choose"],
    name: "Upcoming Project – Ibrahimpatnam",
    builder: "jb-infra",
    projectType: "Premium Gated Villa Community",
    approval: "Approval Process Underway",
    location: "Ibrahimpatnam, Hyderabad",
    seoTitle: "Upcoming 90-Acre Villa Community in Ibrahimpatnam",
    seoDescription: "Upcoming 90-acre gated villa community in Ibrahimpatnam near Sagar Highway and Kongara Kalan, close to Adibatla SEZ, TCS and Foxconn. Register for launch updates.",
  ...
  },
  {
    ...
    relatedInsightSlugs: ["future-city-growth-corridor-whats-driving-land-values", "foxconn-ai-city-and-the-srisailam-belt", "corporate-land-assemblies-reading-hyderabads-next-growth-corridors"],
    ...
    targetKeywords: [
      ...
      "plots near Future City",
      "Mucherla Future City plots",
      "upcoming gated layouts Telangana",
      "new projects Shankarpally",
      "pre launch plots Hyderabad",
      "plots near Thummaloor",
      "Srisailam corridor plots for sale",
    ],
    ...
    faqs: [
      ...
      { q: "What plot sizes and pricing will be available?", a: "Plot sizes and pricing have not been announced yet. The project is a planned 200-acre highway-facing gated township — register with Arjun Realty to receive plot sizes, pricing and launch updates as soon as they are confirmed." },
      { q: "What amenities are planned for the Srisailam Highway township?", a: "Planned amenities include a grand clubhouse, swimming pool, children's play area, landscaped gardens, jogging track, sports courts, wide internal roads, underground utilities, 24×7 security, CCTV surveillance, a grand entrance arch and premium green spaces. Final amenities are confirmed at launch." },
      { q: "How is this different from JB Harmony Woods?", a: "This project is a planned 200-acre integrated township with DTCP & RERA approvals under process, while JB Harmony Woods is a live 53-acre FCDA approved plotted community near Future City, Thummaloor. Both sit in the same Srisailam–Future City growth corridor, so buyers can compare an early-stage township launch against a ready-to-buy approved layout." },
    ],
...
const RELATED_PROJECTS: Record<string, string[]> = {
  ...
  "jb-serene-county": ["jb-serene-city", "jb-pristine-city", "upcoming-shankarpally"],
  "jb-pristine-city": ["jb-serene-county", "shankarpally-45-acres", "upcoming-shankarpally"],
  "jb-serene-city": ["jb-hillside-county", "jb-serene-county", "jb-harmony-woods"],
